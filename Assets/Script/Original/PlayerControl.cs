...
public class PlayerControl : MonoBehaviour {
	...
	void Update () {
        ...
        if (!talking)
        {
            ...
            //Set the horizontal and vertical animation
            anim.SetFloat("speed", Mathf.Max(Mathf.Abs(mov.x), Mathf.Abs(mov.y)) + maxSpeed);
...
//        rb2d.AddForce(Vector2.right * speedDebug * h);
